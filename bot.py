from telegram.ext import Updater, CommandHandler, MessageHandler, Filters  # Extended Telegram API
import telegram
...
class RespondToCommands():
    ...
    def preprocessURL(self, productURL):
        ...
        print(productURL)
        amazonURL = re.match(r'^(https://|http://)(www.)*amazon.it/[a-zA-Z0-9-]*[/]*dp/[A-Z0-9]+[/?]?',productURL)
        if amazonURL:
